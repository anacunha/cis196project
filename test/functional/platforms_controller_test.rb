...
class PlatformsControllerTest < ActionController::TestCase
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post :create, platform: { manufacturer: @platform.manufacturer, name: @platform.name, release_date: @platform.release_date }
    end
  ...
  test "should update platform" do
    put :update, id: @platform, platform: { manufacturer: @platform.manufacturer, name: @platform.name, release_date: @platform.release_date }
    assert_redirected_to platform_path(assigns(:platform))
  end
